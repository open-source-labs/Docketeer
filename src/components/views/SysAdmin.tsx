...
import { Routes, Route, Link, useNavigate, NetworkObj } from 'react-router-dom';
...
import { ContainerObj, StoppedContainerObj, ImageObj, UserObj, VolumeObj } from "./viewsTypes";
...
const SysAdmin = () => {
  ...
  const composeymlFiles = (data) => {
    console.log("Magic47:", data)
    return dispatch(actions.composeymlFiles(data));
  }
  ...
  const runStoppedContainer = (data) =>
    {
    console.log("Magic64:", data)
    return dispatch(actions.runStoppedContainer(data));
  }
